...
router.get("/memDelAll", function (req, res) {
...
router.get("/recoverMemById/:topicId", function (req, res) {
    ...
    common.getMongoClient().then((client) => {
        ...
        dbo.collection("users").updateOne({
            ...
            if (err) throw err;
            console.log("用户已恢复!", dbRes.result.nModified);
            client.close();
        })
    })
